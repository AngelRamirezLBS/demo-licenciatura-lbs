  ...
  async getData() {
      ...
      xmlhttp.onreadystatechange = () => {
        if(xmlhttp.status == 200 && xmlhttp.readyState == 4){
          ...
          this.modal = window.parent.document.getElementById('iframeModal');
          this.closeBtn = window.parent.document.getElementById('closeModalBtn');
          ...
          //   let iFrame = window.parent.document.querySelector(".slider-iframe");
      ...
      xmlhttp.open("GET","componentsAndroid/sliderLbs/sliderLbs.html",true);
      xmlhttp.send();
  }
    ...
    return new Promise(resolve => {
      ...
      .then((data) => {
        ...
        for(let i = 0; i < data[0].titulos.length; i++){
          ...
          var swiperSlide = window.parent.document.createElement("swiper-slide");
          ...
          img.setAttribute("src", `./assets/gamma-page/${this._file}/imagenesSlide/foto${i+1}.jpg`);
          // var clickVideo = window.parent.document.createElement("img");
          ...
          // var title = window.parent.document.createElement("div");
          ...
          // var textData = window.parent.document.createElement("p");
